    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Sign in to manage stores and billing</p>
        </div>

        {/* Login Card */}
        <div className="bg-white rounded-2xl shadow-card-lg p-8 border border-slate-200">
          {error && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all bg-white text-slate-900 placeholder-slate-400"
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          © 2024 SaaS Store. All rights reserved.
        </p>
      </div>
    </div>
  );

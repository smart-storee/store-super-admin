              ...
              {invoices.length === 0 ? (
                ...
                invoices.map((invoice) => (
                  <tr key={invoice.invoice_id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{invoice.store_name}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm capitalize">{invoice.payment_status}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <Link href={`/billing/${invoice.invoice_id}`} className="text-blue-600 hover:text-blue-800">
                        View
                      </Link>
                    </td>
                  </tr>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">SMS Charges</label>
                <input
                  type="number"
                  step="0.01"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Push Notification Charges</label>
                <input
                  type="number"
                  step="0.01"
